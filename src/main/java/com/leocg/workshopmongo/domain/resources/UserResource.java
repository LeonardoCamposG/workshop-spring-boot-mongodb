...
public class UserResource {
	...
	@PostMapping
	public ResponseEntity<Void> insert(@RequestBody UserDTO objDto){	// Response entity encapsula uma resposta de http.
	...
	public ResponseEntity<Void> delete(@PathVariable String id){	// Response entity encapsula uma resposta de http.
		service.delete(id);
